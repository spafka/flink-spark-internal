...
//  */
//case class ExprCode(var code: Block,
...
//  *               the state to use.
//  */
//case class SubExprCodes(codes: Seq[String],
...
//  */
//private[codegen] case class NewFunctionSpec(functionName: String,
...
//    */
//  def addReferenceObj(objName: String,
//                      obj: Any,
...
//    */
//  private[catalyst] val inlinedMutableStates
...
//    * Exposed for tests only.
//    */
//  private[catalyst] val arrayCompactedMutableStates
//    : mutable.Map[String, MutableStateArrays] =
...
//    *         inner class
//    */
//  def addNewFunction(funcName: String,
//                     funcCode: String,
...
//  }
//
//  private[this] def addNewFunctionToClass(funcName: String,
//                                          funcCode: String,
//                                          className: String) = {
...
//    */
//  def reassignIfSmaller(dataType: DataType,
//                        partialResult: ExprCode,
//                        item: ExprCode): String = {
//    s"""
...
//    * @param item `ExprCode` representing the new expression to evaluate for the result
//    */
//  def reassignIfGreater(dataType: DataType,
//                        partialResult: ExprCode,
//                        item: ExprCode): String = {
//    s"""
//       |if (!${item.isNull} && (${partialResult.isNull} ||
...
//    */
//  def nullSafeExec(nullable: Boolean,
//                   isNull: String)(execute: String): String = {
//    if (nullable) {
//      s"""
//        if (!$isNull) {
//          $execute
...
//    *                any null.
//    */
//  def nullArrayElementsSaveExec(nullElements: Boolean,
//                                isNull: String,
//                                arrayData: String)(execute: String): String = {
//    val i = freshName("idx")
//    if (nullElements) {
//      s"""
...
//    * @param foldFunctions folds the split function calls.
//    */
//  def splitExpressions(expressions: Seq[String],
//                       funcName: String,
...
//        } else {
//          orderedFunctions.map(
//            f => s"$innerClassInstance.$f($argInvocationString)"
//          )
//        }
//    }
//  }
...
//  */
//class CodeAndComment(val body: String,
...
//
//    logDebug({
//      // Only add extra debugging info to byte code when we are going to print the source code. //fixme
...
//      evaluator.cook(code.body) // fixme
...
//      case (_, classBytes) =>
//        CodegenMetrics.METRIC_GENERATED_CLASS_BYTECODE_SIZE.update(
//          classBytes.length
//        )
//        try {
...
//                logInfo(
//                  "Generated method too long to be JIT compiled: " + "Generated method too long to be JIT compiled: " +
...
//    */
//  def createArrayData(arrayName: String,
...
//    */
//  def createArrayAssignment(dstArray: String,
//                            elementType: DataType,
//                            srcArray: String,
...
//      case t: DecimalType =>
//        s"$vector.putDecimal($rowId, $value, ${t.precision});"
...
//    */
//  def setArrayElement(array: String,
//                      elementType: DataType,
//                      i: String,
//                      value: String,
...
//    */
//  def updateColumn(vector: String,
//                   rowId: String,
//                   dataType: DataType,
//                   ev: ExprCode,
...
//    */
//  def getValueFromVector(vector: String,
//                         dataType: DataType,
//                         rowId: String): String = {
