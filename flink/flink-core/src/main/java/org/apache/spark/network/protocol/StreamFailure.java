...
public final class StreamFailure extends AbstractMessage implements ResponseMessage {
    ...
    public static org.apache.spark.network.protocol.StreamFailure decode(ByteBuf buf) {
        String streamId = Encoders.Strings.decode(buf);
        String error = Encoders.Strings.decode(buf);
        return new org.apache.spark.network.protocol.StreamFailure(streamId, error);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof org.apache.spark.network.protocol.StreamFailure) {
            org.apache.spark.network.protocol.StreamFailure o = (org.apache.spark.network.protocol.StreamFailure) other;
