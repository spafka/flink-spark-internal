...
public final class ChunkFetchFailure extends AbstractMessage implements ResponseMessage {
    ...
    public static org.apache.spark.network.protocol.ChunkFetchFailure decode(ByteBuf buf) {
        StreamChunkId streamChunkId = StreamChunkId.decode(buf);
        String errorString = Encoders.Strings.decode(buf);
        return new org.apache.spark.network.protocol.ChunkFetchFailure(streamChunkId, errorString);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof org.apache.spark.network.protocol.ChunkFetchFailure) {
            org.apache.spark.network.protocol.ChunkFetchFailure o = (org.apache.spark.network.protocol.ChunkFetchFailure) other;
