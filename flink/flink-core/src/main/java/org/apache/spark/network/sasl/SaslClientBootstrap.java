...
public class SaslClientBootstrap implements TransportClientBootstrap {
    private static final Logger logger = LoggerFactory.getLogger(org.apache.spark.network.sasl.SaslClientBootstrap.class);
    ...
    public void doBootstrap(TransportClient client, Channel channel) {
        ...
        try {
            ...
            while (!saslClient.isComplete()) {
                org.apache.spark.network.sasl.SaslMessage msg = new org.apache.spark.network.sasl.SaslMessage(appId, payload);
