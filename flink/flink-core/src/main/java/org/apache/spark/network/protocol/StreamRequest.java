...
public final class StreamRequest extends AbstractMessage implements RequestMessage {
    ...
    public static org.apache.spark.network.protocol.StreamRequest decode(ByteBuf buf) {
        String streamId = Encoders.Strings.decode(buf);
        return new org.apache.spark.network.protocol.StreamRequest(streamId);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof org.apache.spark.network.protocol.StreamRequest) {
            org.apache.spark.network.protocol.StreamRequest o = (org.apache.spark.network.protocol.StreamRequest) other;
