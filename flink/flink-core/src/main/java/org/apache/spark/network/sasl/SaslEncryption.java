...
class SaslEncryption {
    ...
    static void addToChannel(
            Channel channel,
            org.apache.spark.network.sasl.SaslEncryptionBackend backend,
    ...
    private static class EncryptionHandler extends ChannelOutboundHandlerAdapter {
        ...
        private final org.apache.spark.network.sasl.SaslEncryptionBackend backend;

        EncryptionHandler(org.apache.spark.network.sasl.SaslEncryptionBackend backend, int maxOutboundBlockSize) {
    ...
    private static class DecryptionHandler extends MessageToMessageDecoder<ByteBuf> {
        ...
        DecryptionHandler(org.apache.spark.network.sasl.SaslEncryptionBackend backend) {
            this.backend = backend;
        }
