...
public class TransportResponseHandler extends MessageHandler<ResponseMessage> {
    private static final Logger logger = LoggerFactory.getLogger(org.apache.spark.network.client.TransportResponseHandler.class);
    ...
    public void handle(ResponseMessage message) throws Exception {
        if (message instanceof ChunkFetchSuccess) {
            ...
            if (callback != null) {
                if (resp.byteCount > 0) {
                    org.apache.spark.network.client.StreamInterceptor interceptor = new org.apache.spark.network.client.StreamInterceptor(this, resp.streamId, resp.byteCount,
                            callback);
                    try {
