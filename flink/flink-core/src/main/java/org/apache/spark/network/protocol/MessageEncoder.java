...
public final class MessageEncoder extends MessageToMessageEncoder<Message> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(org.apache.spark.network.protocol.MessageEncoder.class);

    public static final org.apache.spark.network.protocol.MessageEncoder INSTANCE = new org.apache.spark.network.protocol.MessageEncoder();
    ...
    public void encode(ChannelHandlerContext ctx, Message in, List<Object> out) throws Exception {
        ...
        if (body != null) {
            ...
            out.add(new org.apache.spark.network.protocol.MessageWithHeader(in.body(), header, body, bodyLength));
        } else {
            out.add(header);
        }
    }
