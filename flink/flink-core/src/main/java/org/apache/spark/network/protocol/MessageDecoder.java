...
public final class MessageDecoder extends MessageToMessageDecoder<ByteBuf> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(org.apache.spark.network.protocol.MessageDecoder.class);

    public static final org.apache.spark.network.protocol.MessageDecoder INSTANCE = new org.apache.spark.network.protocol.MessageDecoder();
