...
public final class StreamChunkId implements Encodable {
    ...
    public static org.apache.spark.network.protocol.StreamChunkId decode(ByteBuf buffer) {
        assert buffer.readableBytes() >= 8 + 4;
        long streamId = buffer.readLong();
        int chunkIndex = buffer.readInt();
        return new org.apache.spark.network.protocol.StreamChunkId(streamId, chunkIndex);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof org.apache.spark.network.protocol.StreamChunkId) {
            org.apache.spark.network.protocol.StreamChunkId o = (org.apache.spark.network.protocol.StreamChunkId) other;
