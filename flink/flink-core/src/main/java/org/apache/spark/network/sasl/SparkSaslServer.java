 ...
 */
public class SparkSaslServer implements org.apache.spark.network.sasl.SaslEncryptionBackend {
    private static final Logger logger = LoggerFactory.getLogger(org.apache.spark.network.sasl.SparkSaslServer.class);
