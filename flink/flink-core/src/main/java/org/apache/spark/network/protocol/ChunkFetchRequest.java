...
public final class ChunkFetchRequest extends AbstractMessage implements RequestMessage {
    ...
    public static org.apache.spark.network.protocol.ChunkFetchRequest decode(ByteBuf buf) {
        return new org.apache.spark.network.protocol.ChunkFetchRequest(StreamChunkId.decode(buf));
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof org.apache.spark.network.protocol.ChunkFetchRequest) {
            org.apache.spark.network.protocol.ChunkFetchRequest o = (org.apache.spark.network.protocol.ChunkFetchRequest) other;
