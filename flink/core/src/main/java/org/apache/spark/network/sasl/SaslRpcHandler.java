...
class SaslRpcHandler extends RpcHandler {
    private static final Logger logger = LoggerFactory.getLogger(org.apache.spark.network.sasl.SaslRpcHandler.class);
    ...
    public void receive(TransportClient client, ByteBuffer message, RpcResponseCallback callback) {
        ...
        org.apache.spark.network.sasl.SaslMessage saslMessage;
        try {
            saslMessage = org.apache.spark.network.sasl.SaslMessage.decode(nettyBuf);
        } finally {
            nettyBuf.release();
        }
