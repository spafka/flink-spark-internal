...
import com.github.spafka.mesos.TaskMonitor._
...
class Tasks(
  ...
  /**
    ...
    */
  private[mesos] var registered: Option[Any] = None
...
object Tasks {
  ...
  def createActorProps[T <: Tasks, M <: TaskMonitor](
    ...
    Props.create(actorClass, manager, schedulerDriver, taskMonitorCreator)
  }
}
