...
//import java.io.File
//
//import org.apache.mesos.Protos.{ExecutorInfo, TaskState, TaskStatus}
//import org.apache.mesos.{Scheduler => NScheduler, _}
//
...
//  }
//
//  def getFrameworkName(d: SchedulerDriver): String = frameworkName
//
